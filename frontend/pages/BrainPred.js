...
// //     try {
// //       const response = await fetch('http://localhost:5000/process_brain', {
// //         method: 'POST',
// //         body: formData,
// //       });
// //       if (!response.ok) {
...
//     formData.append('image', file);
//     try {
//       const response = await fetch('http://localhost:5000/process_fracture ', {
//         method: 'POST',
//         body: formData,
//       });
//       if (!response.ok) {
...
const BrainPred = () => {
  ...
  const [location, setLocation] = useState(''); // Add loading state
  ...
  return (
    <div className="bg-gradient-to-br from-green-200 to-blue-900 min-h-screen flex items-center justify-center bg-gray-100">
      <div className="min-w-md w-full bg-white p-8 rounded-lg shadow-lg">
        {/* <img src='C:\Users\visha\Desktop\ml\frontend\src\components\OrgSeg.png' alt='Image'/> */}
        <h2 className="text-2xl mb-4">Upload Brain-MRI scan to diagnose</h2>
        <input type="file" accept="image/*" onChange={handleFileChange} className="mb-4" />
        <div className="flex mb-4">
          {imageURL && (
            <div className="flex-1 mr-2">
...
//   return (
//     <div className="bg-gradient-to-br from-green-100 to-blue-100 min-h-screen flex items-center justify-center bg-gray-100">
//       <div className="min-w-md w-full bg-white p-8 rounded-lg shadow-lg">
